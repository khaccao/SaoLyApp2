        ...
        <View style={styles.productContainer}>
          <View style={styles.productCard}>
            ...
            <View style={styles.productInfo}>
              <Text style={styles.productText}>Tên voucher:</Text>
              <Text style={styles.productText}>Thời gian:</Text>
              <Text style={styles.productText}>Cơ sở:</Text>
              <Text style={styles.productText}>Số lượng:</Text>
            </View>
...
export default AdmintatcaVoucher
