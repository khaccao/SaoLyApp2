        ...
        <View style={styles.productContainer}>
          <View style={styles.productCard}>
            ...
            <View style={styles.productInfo}>
              <Text style={styles.productText}>Tên sản phẩm:</Text>
              <Text style={styles.productText}>Xuất xứ:</Text>
              <Text style={styles.productText}>Mô tả:   </Text>
              <View style={styles.quantityControl}>
                <Ionicons name="remove-outline" size={24} color="black" />
                <TextInput style={styles.quantityInput} defaultValue="0" keyboardType="numeric" />
                <Ionicons name="add-outline" size={24} color="black" />
              </View>
              <Text style={styles.productPrice}>Giá tiền: 100.000.000đ</Text>
            </View>
...
export default AdmintatcaSanpham;
