    ...
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={styles.container}>
        ...
        <ScrollView style={styles.formContainer}>
          ...
          <Text style={styles.sectionSubtitle}>Nhấn để chuyển nhanh đến địa điểm khác</Text>
          <TouchableOpacity style={styles.floorButton}>
            <Text style={styles.floorButtonText}>#Tầng 2</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.floorButton1}>
            <Text style={styles.floorButtonText}>#Tầng 3</Text>
          </TouchableOpacity>
        </ScrollView>
        </ScrollView>
